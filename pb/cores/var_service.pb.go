...
var file_cores_var_service_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x70, 0x62, 0x2e, 0x56, 0x61, 0x72, 0x52, 0x03, 0x76, 0x61,
	0x72, 0x32, 0x80, 0x06, 0x0a, 0x0a, 0x56, 0x61, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x70, 0x62, 0x2e, 0x56, 0x61, 0x72, 0x1a, 0x0a, 0x2e, 0x70, 0x62, 0x2e, 0x4d, 0x79, 0x42, 0x6f,
...
var file_cores_var_service_proto_depIdxs = []int32{
	...
	9,  // 20: cores.VarService.Sync:input_type -> pb.Var
	9,  // 21: cores.VarService.Create:output_type -> pb.Var
	9,  // 22: cores.VarService.Update:output_type -> pb.Var
	9,  // 23: cores.VarService.View:output_type -> pb.Var
	9,  // 24: cores.VarService.ViewByName:output_type -> pb.Var
	9,  // 25: cores.VarService.ViewByNameFull:output_type -> pb.Var
	13, // 26: cores.VarService.Delete:output_type -> pb.MyBool
	1,  // 27: cores.VarService.List:output_type -> cores.ListVarResponse
	13, // 28: cores.VarService.Clone:output_type -> pb.MyBool
	12, // 29: cores.VarService.GetValue:output_type -> pb.VarValue
	13, // 30: cores.VarService.SetValue:output_type -> pb.MyBool
	13, // 31: cores.VarService.SetValueUnchecked:output_type -> pb.MyBool
	5,  // 32: cores.VarService.GetValueByName:output_type -> cores.VarNameValue
	13, // 33: cores.VarService.SetValueByName:output_type -> pb.MyBool
	13, // 34: cores.VarService.SetValueByNameUnchecked:output_type -> pb.MyBool
	9,  // 35: cores.VarService.ViewWithDeleted:output_type -> pb.Var
	7,  // 36: cores.VarService.Pull:output_type -> cores.PullVarResponse
	13, // 37: cores.VarService.Sync:output_type -> pb.MyBool
