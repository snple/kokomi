...
var file_cores_proxy_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x78, 0x79, 0x52, 0x05, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x32, 0x95, 0x04, 0x0a, 0x0c,
	...
	0x50, 0x72, 0x6f, 0x78, 0x79, 0x1a, 0x0a, 0x2e, 0x70, 0x62, 0x2e, 0x4d, 0x79, 0x42, 0x6f, 0x6f,
...
var file_cores_proxy_service_proto_depIdxs = []int32{
	...
	8,  // 19: cores.ProxyService.ViewByName:output_type -> pb.Proxy
	8,  // 20: cores.ProxyService.ViewByNameFull:output_type -> pb.Proxy
	11, // 21: cores.ProxyService.Delete:output_type -> pb.MyBool
	1,  // 22: cores.ProxyService.List:output_type -> cores.ListProxyResponse
	...
	6,  // 26: cores.ProxyService.Pull:output_type -> cores.PullProxyResponse
