...
var file_cores_sync_service_proto_rawDesc = []byte{
	...
	0x01, 0x32, 0x13, 0x0a, 0x11, 0x53, 0x79, 0x6e, 0x63, 0x47, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x42, 0x28, 0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_cores_sync_service_proto_depIdxs = []int32{
	...
	2, // 6: cores.SyncService.SetDeviceUpdated:output_type -> pb.MyBool
	0, // 7: cores.SyncService.GetDeviceUpdated:output_type -> cores.SyncUpdated
	2, // 8: cores.SyncService.WaitDeviceUpdated:output_type -> pb.MyBool
	2, // 9: cores.SyncService.SetTagValueUpdated:output_type -> pb.MyBool
	0, // 10: cores.SyncService.GetTagValueUpdated:output_type -> cores.SyncUpdated
	2, // 11: cores.SyncService.WaitTagValueUpdated:output_type -> pb.MyBool
