...
type SyncServiceClient interface {
	...
	GetWireValueUpdated(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (*SyncUpdated, error)
	WaitWireValueUpdated(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (SyncService_WaitWireValueUpdatedClient, error)
}
...
func (c *syncServiceClient) SetDeviceUpdated(ctx context.Context, in *SyncUpdated, opts ...grpc.CallOption) (*pb.MyBool, error) {
	out := new(pb.MyBool)
	err := c.cc.Invoke(ctx, "/cores.SyncService/SetDeviceUpdated", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *syncServiceClient) GetDeviceUpdated(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (*SyncUpdated, error) {
	out := new(SyncUpdated)
	err := c.cc.Invoke(ctx, "/cores.SyncService/GetDeviceUpdated", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *syncServiceClient) WaitDeviceUpdated(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (SyncService_WaitDeviceUpdatedClient, error) {
	stream, err := c.cc.NewStream(ctx, &SyncService_ServiceDesc.Streams[0], "/cores.SyncService/WaitDeviceUpdated", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *syncServiceClient) SetTagValueUpdated(ctx context.Context, in *SyncUpdated, opts ...grpc.CallOption) (*pb.MyBool, error) {
	out := new(pb.MyBool)
	err := c.cc.Invoke(ctx, "/cores.SyncService/SetTagValueUpdated", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *syncServiceClient) GetTagValueUpdated(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (*SyncUpdated, error) {
	out := new(SyncUpdated)
	err := c.cc.Invoke(ctx, "/cores.SyncService/GetTagValueUpdated", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *syncServiceClient) WaitTagValueUpdated(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (SyncService_WaitTagValueUpdatedClient, error) {
	stream, err := c.cc.NewStream(ctx, &SyncService_ServiceDesc.Streams[1], "/cores.SyncService/WaitTagValueUpdated", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *syncServiceClient) SetWireValueUpdated(ctx context.Context, in *SyncUpdated, opts ...grpc.CallOption) (*pb.MyBool, error) {
	out := new(pb.MyBool)
	err := c.cc.Invoke(ctx, "/cores.SyncService/SetWireValueUpdated", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *syncServiceClient) GetWireValueUpdated(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (*SyncUpdated, error) {
	out := new(SyncUpdated)
	err := c.cc.Invoke(ctx, "/cores.SyncService/GetWireValueUpdated", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *syncServiceClient) WaitWireValueUpdated(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (SyncService_WaitWireValueUpdatedClient, error) {
	stream, err := c.cc.NewStream(ctx, &SyncService_ServiceDesc.Streams[2], "/cores.SyncService/WaitWireValueUpdated", opts...)
	if err != nil {
		return nil, err
	}
...
type SyncServiceServer interface {
	...
	GetWireValueUpdated(context.Context, *pb.Id) (*SyncUpdated, error)
	WaitWireValueUpdated(*pb.Id, SyncService_WaitWireValueUpdatedServer) error
...
func (UnimplementedSyncServiceServer) GetWireValueUpdated(context.Context, *pb.Id) (*SyncUpdated, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetWireValueUpdated not implemented")
}
func (UnimplementedSyncServiceServer) WaitWireValueUpdated(*pb.Id, SyncService_WaitWireValueUpdatedServer) error {
...
func _SyncService_SetDeviceUpdated_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SyncService/SetDeviceUpdated",
	}
...
func _SyncService_GetDeviceUpdated_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SyncService/GetDeviceUpdated",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SyncService_SetTagValueUpdated_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SyncService/SetTagValueUpdated",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SyncService_GetTagValueUpdated_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SyncService/GetTagValueUpdated",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SyncService_SetWireValueUpdated_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SyncService/SetWireValueUpdated",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SyncService_GetWireValueUpdated_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SyncService/GetWireValueUpdated",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SyncServiceServer).GetWireValueUpdated(ctx, req.(*pb.Id))
	}
	return interceptor(ctx, in, info, handler)
}
