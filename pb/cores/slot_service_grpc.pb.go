...
type SlotServiceClient interface {
	...
	ViewByName(ctx context.Context, in *ViewSlotByNameRequest, opts ...grpc.CallOption) (*pb.Slot, error)
	ViewByNameFull(ctx context.Context, in *pb.Name, opts ...grpc.CallOption) (*pb.Slot, error)
...
func (c *slotServiceClient) Create(ctx context.Context, in *pb.Slot, opts ...grpc.CallOption) (*pb.Slot, error) {
	out := new(pb.Slot)
	err := c.cc.Invoke(ctx, "/cores.SlotService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slotServiceClient) Update(ctx context.Context, in *pb.Slot, opts ...grpc.CallOption) (*pb.Slot, error) {
	out := new(pb.Slot)
	err := c.cc.Invoke(ctx, "/cores.SlotService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slotServiceClient) View(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (*pb.Slot, error) {
	out := new(pb.Slot)
	err := c.cc.Invoke(ctx, "/cores.SlotService/View", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slotServiceClient) ViewByName(ctx context.Context, in *ViewSlotByNameRequest, opts ...grpc.CallOption) (*pb.Slot, error) {
	out := new(pb.Slot)
	err := c.cc.Invoke(ctx, "/cores.SlotService/ViewByName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slotServiceClient) ViewByNameFull(ctx context.Context, in *pb.Name, opts ...grpc.CallOption) (*pb.Slot, error) {
	out := new(pb.Slot)
	err := c.cc.Invoke(ctx, "/cores.SlotService/ViewByNameFull", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slotServiceClient) Delete(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (*pb.MyBool, error) {
	out := new(pb.MyBool)
	err := c.cc.Invoke(ctx, "/cores.SlotService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slotServiceClient) List(ctx context.Context, in *ListSlotRequest, opts ...grpc.CallOption) (*ListSlotResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cores.SlotService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slotServiceClient) Link(ctx context.Context, in *LinkSlotRequest, opts ...grpc.CallOption) (*pb.MyBool, error) {
	out := new(pb.MyBool)
	err := c.cc.Invoke(ctx, "/cores.SlotService/Link", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slotServiceClient) Clone(ctx context.Context, in *CloneSlotRequest, opts ...grpc.CallOption) (*pb.MyBool, error) {
	out := new(pb.MyBool)
	err := c.cc.Invoke(ctx, "/cores.SlotService/Clone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slotServiceClient) ViewWithDeleted(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (*pb.Slot, error) {
	out := new(pb.Slot)
	err := c.cc.Invoke(ctx, "/cores.SlotService/ViewWithDeleted", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slotServiceClient) Pull(ctx context.Context, in *PullSlotRequest, opts ...grpc.CallOption) (*PullSlotResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cores.SlotService/Pull", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SlotServiceServer interface {
	...
	ViewByName(context.Context, *ViewSlotByNameRequest) (*pb.Slot, error)
	ViewByNameFull(context.Context, *pb.Name) (*pb.Slot, error)
...
func (UnimplementedSlotServiceServer) ViewByName(context.Context, *ViewSlotByNameRequest) (*pb.Slot, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ViewByName not implemented")
}
func (UnimplementedSlotServiceServer) ViewByNameFull(context.Context, *pb.Name) (*pb.Slot, error) {
...
func _SlotService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SlotService/Create",
	}
...
func _SlotService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SlotService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SlotService_View_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SlotService/View",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SlotService_ViewByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SlotService/ViewByName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SlotServiceServer).ViewByName(ctx, req.(*ViewSlotByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SlotService_ViewByNameFull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.Name)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SlotServiceServer).ViewByNameFull(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SlotService/ViewByNameFull",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SlotServiceServer).ViewByNameFull(ctx, req.(*pb.Name))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SlotService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SlotService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SlotService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SlotService/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SlotService_Link_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SlotService/Link",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SlotService_Clone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SlotService/Clone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SlotService_ViewWithDeleted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SlotService/ViewWithDeleted",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SlotService_Pull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.SlotService/Pull",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var SlotService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SlotService_ViewByNameFull_Handler,
		},
		{
			MethodName: "Delete",
