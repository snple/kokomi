...
type OptionServiceClient interface {
	...
	ViewByName(ctx context.Context, in *ViewOptionByNameRequest, opts ...grpc.CallOption) (*pb.Option, error)
	ViewByNameFull(ctx context.Context, in *pb.Name, opts ...grpc.CallOption) (*pb.Option, error)
...
func (c *optionServiceClient) Create(ctx context.Context, in *pb.Option, opts ...grpc.CallOption) (*pb.Option, error) {
	out := new(pb.Option)
	err := c.cc.Invoke(ctx, "/cores.OptionService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *optionServiceClient) Update(ctx context.Context, in *pb.Option, opts ...grpc.CallOption) (*pb.Option, error) {
	out := new(pb.Option)
	err := c.cc.Invoke(ctx, "/cores.OptionService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *optionServiceClient) View(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (*pb.Option, error) {
	out := new(pb.Option)
	err := c.cc.Invoke(ctx, "/cores.OptionService/View", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *optionServiceClient) ViewByName(ctx context.Context, in *ViewOptionByNameRequest, opts ...grpc.CallOption) (*pb.Option, error) {
	out := new(pb.Option)
	err := c.cc.Invoke(ctx, "/cores.OptionService/ViewByName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *optionServiceClient) ViewByNameFull(ctx context.Context, in *pb.Name, opts ...grpc.CallOption) (*pb.Option, error) {
	out := new(pb.Option)
	err := c.cc.Invoke(ctx, "/cores.OptionService/ViewByNameFull", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *optionServiceClient) Delete(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (*pb.MyBool, error) {
	out := new(pb.MyBool)
	err := c.cc.Invoke(ctx, "/cores.OptionService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *optionServiceClient) List(ctx context.Context, in *ListOptionRequest, opts ...grpc.CallOption) (*ListOptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cores.OptionService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *optionServiceClient) Clone(ctx context.Context, in *CloneOptionRequest, opts ...grpc.CallOption) (*pb.MyBool, error) {
	out := new(pb.MyBool)
	err := c.cc.Invoke(ctx, "/cores.OptionService/Clone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *optionServiceClient) ViewWithDeleted(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (*pb.Option, error) {
	out := new(pb.Option)
	err := c.cc.Invoke(ctx, "/cores.OptionService/ViewWithDeleted", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *optionServiceClient) Pull(ctx context.Context, in *PullOptionRequest, opts ...grpc.CallOption) (*PullOptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cores.OptionService/Pull", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OptionServiceServer interface {
	...
	ViewByName(context.Context, *ViewOptionByNameRequest) (*pb.Option, error)
	ViewByNameFull(context.Context, *pb.Name) (*pb.Option, error)
...
func (UnimplementedOptionServiceServer) ViewByName(context.Context, *ViewOptionByNameRequest) (*pb.Option, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ViewByName not implemented")
}
func (UnimplementedOptionServiceServer) ViewByNameFull(context.Context, *pb.Name) (*pb.Option, error) {
...
func _OptionService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.OptionService/Create",
	}
...
func _OptionService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.OptionService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OptionService_View_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.OptionService/View",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OptionService_ViewByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ViewOptionByNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.OptionService/ViewByName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OptionServiceServer).ViewByName(ctx, req.(*ViewOptionByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _OptionService_ViewByNameFull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.Name)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OptionServiceServer).ViewByNameFull(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.OptionService/ViewByNameFull",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OptionServiceServer).ViewByNameFull(ctx, req.(*pb.Name))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OptionService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.OptionService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OptionService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.OptionService/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OptionService_Clone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.OptionService/Clone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OptionService_ViewWithDeleted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.OptionService/ViewWithDeleted",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OptionService_Pull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cores.OptionService/Pull",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var OptionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OptionService_ViewByNameFull_Handler,
		},
		{
			MethodName: "Delete",
