...
const (
	...
	OptionService_ViewByName_FullMethodName      = "/cores.OptionService/ViewByName"
	OptionService_ViewByNameFull_FullMethodName  = "/cores.OptionService/ViewByNameFull"
...
func (c *optionServiceClient) ViewByNameFull(ctx context.Context, in *pb.Name, opts ...grpc.CallOption) (*pb.Option, error) {
	out := new(pb.Option)
	err := c.cc.Invoke(ctx, OptionService_ViewByNameFull_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OptionService_ViewByNameFull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OptionService_ViewByNameFull_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
