...
const (
	...
	ClassService_ViewByName_FullMethodName      = "/cores.ClassService/ViewByName"
	ClassService_ViewByNameFull_FullMethodName  = "/cores.ClassService/ViewByNameFull"
...
func (c *classServiceClient) ViewByNameFull(ctx context.Context, in *pb.Name, opts ...grpc.CallOption) (*pb.Class, error) {
	out := new(pb.Class)
	err := c.cc.Invoke(ctx, ClassService_ViewByNameFull_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ClassService_ViewByNameFull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClassService_ViewByNameFull_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	...
	AttrService_ViewByName_FullMethodName              = "/cores.AttrService/ViewByName"
	AttrService_ViewByNameFull_FullMethodName          = "/cores.AttrService/ViewByNameFull"
	...
	AttrService_SetValueUnchecked_FullMethodName       = "/cores.AttrService/SetValueUnchecked"
	...
	AttrService_SetValueByNameUnchecked_FullMethodName = "/cores.AttrService/SetValueByNameUnchecked"
...
func (c *attrServiceClient) ViewByNameFull(ctx context.Context, in *pb.Name, opts ...grpc.CallOption) (*pb.Attr, error) {
	out := new(pb.Attr)
	err := c.cc.Invoke(ctx, AttrService_ViewByNameFull_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AttrService_ViewByNameFull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AttrService_ViewByNameFull_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
