...
var file_cores_device_service_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0x8c, 0x03, 0x0a, 0x0d, 0x44, 0x65, 0x76, 0x69, 0x63,
	...
	0x6c, 0x22, 0x00, 0x12, 0x20, 0x0a, 0x04, 0x53, 0x79, 0x6e, 0x63, 0x12, 0x0a, 0x2e, 0x70, 0x62,
...
var file_cores_device_service_proto_depIdxs = []int32{
	...
	4,  // 12: cores.DeviceService.Sync:input_type -> pb.Device
	4,  // 13: cores.DeviceService.Create:output_type -> pb.Device
	4,  // 14: cores.DeviceService.Update:output_type -> pb.Device
	4,  // 15: cores.DeviceService.View:output_type -> pb.Device
	4,  // 16: cores.DeviceService.ViewByName:output_type -> pb.Device
	7,  // 17: cores.DeviceService.Delete:output_type -> pb.MyBool
	1,  // 18: cores.DeviceService.List:output_type -> cores.ListDeviceResponse
	7,  // 19: cores.DeviceService.Link:output_type -> pb.MyBool
	7,  // 20: cores.DeviceService.Destory:output_type -> pb.MyBool
	7,  // 21: cores.DeviceService.Clone:output_type -> pb.MyBool
	7,  // 22: cores.DeviceService.Sync:output_type -> pb.MyBool
