...
var file_nodes_device_service_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x11, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xbf, 0x02,
	...
	0x6f, 0x6f, 0x6c, 0x22, 0x00, 0x12, 0x28, 0x0a, 0x09, 0x4b, 0x65, 0x65, 0x70, 0x41, 0x6c, 0x69,
...
var file_nodes_device_service_proto_depIdxs = []int32{
	...
	4, // 6: nodes.DeviceService.KeepAlive:input_type -> pb.MyEmpty
	1, // 7: nodes.DeviceService.Login:output_type -> nodes.DeviceLoginReply
	3, // 8: nodes.DeviceService.Update:output_type -> pb.Device
	3, // 9: nodes.DeviceService.View:output_type -> pb.Device
	5, // 10: nodes.DeviceService.Link:output_type -> pb.MyBool
	3, // 11: nodes.DeviceService.ViewWithDeleted:output_type -> pb.Device
	5, // 12: nodes.DeviceService.Sync:output_type -> pb.MyBool
	5, // 13: nodes.DeviceService.KeepAlive:output_type -> pb.MyBool
...
func file_nodes_device_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nodes_device_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_nodes_device_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_nodes_device_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
