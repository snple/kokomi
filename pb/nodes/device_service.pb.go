...
var file_nodes_device_service_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x11, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xc5, 0x01,
...
var file_nodes_device_service_proto_depIdxs = []int32{
	...
	1, // 4: nodes.DeviceService.Login:output_type -> nodes.LoginDeviceReply
	3, // 5: nodes.DeviceService.Update:output_type -> pb.Device
	3, // 6: nodes.DeviceService.View:output_type -> pb.Device
	5, // 7: nodes.DeviceService.Link:output_type -> pb.MyBool
