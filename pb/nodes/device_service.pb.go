...
var file_nodes_device_service_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x11, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xe7, 0x01,
	...
	0x6f, 0x6f, 0x6c, 0x22, 0x00, 0x12, 0x20, 0x0a, 0x04, 0x53, 0x79, 0x6e, 0x63, 0x12, 0x0a, 0x2e,
	0x70, 0x62, 0x2e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x1a, 0x0a, 0x2e, 0x70, 0x62, 0x2e, 0x4d,
...
var file_nodes_device_service_proto_depIdxs = []int32{
	...
	3, // 4: nodes.DeviceService.Sync:input_type -> pb.Device
	1, // 5: nodes.DeviceService.Login:output_type -> nodes.LoginDeviceReply
	3, // 6: nodes.DeviceService.Update:output_type -> pb.Device
	3, // 7: nodes.DeviceService.View:output_type -> pb.Device
	5, // 8: nodes.DeviceService.Link:output_type -> pb.MyBool
	5, // 9: nodes.DeviceService.Sync:output_type -> pb.MyBool
