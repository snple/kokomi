...
func file_const_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_const_message_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Const); i {
			case 0:
				return &v.state
			case 1:
		...
		file_const_message_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_const_message_proto_msgTypes[2].Exporter = func(v any, i int) any {
