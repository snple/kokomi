...
func file_generic_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_generic_message_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_generic_message_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Id); i {
			case 0:
				return &v.state
			case 1:
		...
		file_generic_message_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Name); i {
			case 0:
				return &v.state
			case 1:
		...
		file_generic_message_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_generic_message_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*MyBool); i {
			case 0:
				return &v.state
			case 1:
		...
		file_generic_message_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Page); i {
			case 0:
				return &v.state
			case 1:
